/**
 * @file
 * Yanked from https://codesandbox.io/s/react-three-fiber-camera-controls-4jjor?file=/src/camera-controls.tsx,
 * adapts the `camera-controls` class to a React component.
 */
import React, {
  forwardRef,
  ForwardedRef,
