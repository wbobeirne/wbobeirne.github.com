...
/***/ function(module, exports, __webpack_require__) {
	...
	var $, Hexes, _, noTransTimeout;

	$ = __webpack_require__(1);

	_ = __webpack_require__(2);

	Hexes = __webpack_require__(3);
	...
	window.Home = {
	  ...
	  bind: function() {
	    $(window).on("resize focus", (function(_this) {
	      return function(ev) {
	        ...
	        _this.Data.window.width = $window.width();
	        ref = _this.Data.onResizes;
	  ...
	  bindHeader: function() {
	    ...
	    fn = (function(_this) {
	      return function() {
	        var target;
	        target = _this.Data.window.height / 2;
	        return _this.Dom.header.toggleClass("isTransparent", _this.Data.window.scrollTop < target);
	      };
	    })(this);
	    this.Data.onScrolls.push(fn);
	    return this.Data.onResizes.push(fn);
	  },
	  bindHeaderLinks: function() {
	    ...
	    this.Dom.header.find("[data-smooth-anchor]").each(function(idx, el) {
	      ...
	      return headerLinks.push({
	        el: $(el),
	        target: $target
	      });
	    });
	    retargetHeaderLinks = (function(_this) {
	      return function() {
	        var i, len, link, results;
	        results = [];
	        for (i = 0, len = headerLinks.length; i < len; i++) {
	          link = headerLinks[i];
	          results.push(link.scrollTop = link.target.offset().top - _this.Data.window.height / 2);
	        }
	        return results;
	      };
	    })(this);
	    markActiveLink = (function(_this) {
	      return function() {
	        var i, len, link;
	        for (i = 0, len = headerLinks.length; i < len; i++) {
	          link = headerLinks[i];
	          if (_this.Data.window.scrollTop > link.scrollTop) {
	            if (activeLink === link.el) {
	              return;
	            }
	            if (activeLink != null) {
	    ...
	    retargetHeaderLinks();
	    this.Data.onScrolls.push(markActiveLink);
	    this.Data.onResizes.push(retargetHeaderLinks);
	    return this.Data.onResizes.push(markActiveLink);
	  },
	  bindSmoothAnchors: function() {
	    return this.Dom.smoothAnchors.on("click", (function(_this) {
	      return function(ev) {
	        var $target;
	        if (!window.history) {
	          return;
	  ...
	  bindScrollers: function() {
	    this.cacheScrollers();
	    this.Data.onResizes.push(_.debounce((function(_this) {
	      return function() {
	        return _this.cacheScrollers();
	      };
	    })(this), 100));
	    return this.Data.onScrolls.push((function(_this) {
	      return function() {
	        return _this.checkScrollers();
	      };
	    })(this));
	  },
